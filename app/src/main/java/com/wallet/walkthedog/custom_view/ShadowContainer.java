...
//        int shadowColor = Color.RED;
        float shadowRadius = a.getDimension(R.styleable.ShadowContainer_containerShadowRadius, 10);
        deltaLength = a.getDimension(R.styleable.ShadowContainer_containerDeltaLength, 15);
        cornerRadius = a.getDimension(R.styleable.ShadowContainer_containerCornerRadius, 10);
        float dx = a.getDimension(R.styleable.ShadowContainer_deltaX, 3);
        float dy = a.getDimension(R.styleable.ShadowContainer_deltaY, 10);
